...
class DinoPlayer extends SpriteAnimationComponent with HasGameRef{
  ...
  // late final SpriteAnimation _walkingTopAnimation;
  ...
  updatePosition(double dt){
    switch (direction){
      case Direction.up:
        // animation = _walkingTopAnimation;
        position.y--;
        break;
      case Direction.down:
        position.y++;
  ...
  Future<void> _loadAnimations() async {
      ...
      // _walkingTopAnimation = spriteSheet.createAnimation(
      //   row: 1, stepTime: _animationSpeed , from:0, to: 9 );
